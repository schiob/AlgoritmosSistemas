...
public class Practica8 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Escrice el número de personas, número de conexiones entre 2 personas y numero identificador de Juan <3:");
        int N = scanner.nextInt();
        int E = scanner.nextInt();
        int Z = scanner.nextInt();
        System.out.println("Escribe las aristas dependiendo del numero de conexiones:");
