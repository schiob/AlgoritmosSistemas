# MergeSort sacado de las prácticas pasadas.
    ...
    for i in range(0,len(lista)):
        for j in lista[i]:
            if j[-1] == 'X':
                ...
                return 'Ese tipo de boleto no existe brother, sorry, solamente aceptamos X o B, no sabes leer? hasta parece que te gusta one piece LUL'
    return 'No hay boleto ganador brother ;('
