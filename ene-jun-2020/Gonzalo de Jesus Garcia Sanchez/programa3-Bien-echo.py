...
#cadenas = ["CANDESARTAN HIDROCLOROTIAZIDA ALTER","CARBAMAZEPINA NORMON","MATRIF","ACICLOVIR SANDOZ","MELOXICAM","FENDIVIA","SEBUMSELEN"]
...
# print(len(cadena[2]))
# print(a)
#CANDESARTAN HIDROCLOROTIAZIDA ALTER CARBAMAZEPINA NORMON MATRIF ACICLOVIR SANDOZ MELOXICAM FENDIVIA SEBUMSELEN
