...
$MyArray = array("TheLeyendOfZelda", "SuperMario64", "MegaMan3", "PokemonBlue", "MetalSlug2");
$n = 5;
$q = 3;
$values = ["SuperMario64","PokemonBlue","PokemonRed"];
echo "Videojuegos: "."<br>";
PrintArray($MyArray, $n);  
quicksort($MyArray, 0, $n-1);
echo "<br>"."\nVideojuegos ordenados: \n"."<br>";
PrintArray($MyArray, $n);
echo "<br>"."\nVideojuegos encontrados y su posicion: \n";
for($i = 0; $q>$i; $i++){
  $value = $values[$i];
