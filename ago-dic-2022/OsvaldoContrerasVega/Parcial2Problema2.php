...
function quicksort(&$Array, $left, $right) {
  ...
  $MyArray = array('FiestaDeLocos ', 'Matador ', 'Comprendes,Mendes? ',
  'PadreNuestro ', 'YoTomo ', 'Frijolero ', 'SiSeñor ', 'Imagina ');
  $n = 8; //cuantas son
  $q = 4; // cuantos elementos a buscar
  $values = ['SiSeñor ', 'Imagina ', 'PadreNuestro ', 'Matador ']; //valores a buscar
