...
n, m = map(int, input("2 numeros enteros separados por espacios n1:problemas que tiene, n2:minutos que tiene disponible: ").split())  # Leer el número de problemas y los minutos disponibles
